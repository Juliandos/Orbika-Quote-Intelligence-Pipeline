...
CONFIG = {'provider_id': 'fanauto', 'display_name': 'Fanauto', 'max_pages': 8, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': True, 'static_entry_urls': ('https://fanauto.com.co/catalogo-digital/',), 'allow_category_records': True, 'extra_product_patterns': (), 'extra_category_patterns': (), 'disallowed_url_patterns': ()}
