...
CONFIG = {'provider_id': 'ventarepuestosmayor', 'display_name': 'Venta Repuestos Mayor', 'max_pages': 8, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': True, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': True, 'extra_product_patterns': (), 'extra_category_patterns': (), 'disallowed_url_patterns': ()}
