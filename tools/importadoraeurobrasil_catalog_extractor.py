...
CONFIG = {'provider_id': 'importadoraeurobrasil', 'display_name': 'Importadora EuroBrasil', 'max_pages': 24, 'max_products': 80, 'category_only_mode': False, 'prefer_vehicle_match': True, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': False, 'extra_product_patterns': ('/producto/',), 'extra_category_patterns': (), 'disallowed_url_patterns': ()}
