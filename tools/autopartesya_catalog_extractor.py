...
CONFIG = {'provider_id': 'autopartesya', 'display_name': 'Autopartesya', 'max_pages': 12, 'max_products': 40, 'category_only_mode': False, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': False, 'extra_product_patterns': ('/product/',), 'extra_category_patterns': (), 'disallowed_url_patterns': ()}
