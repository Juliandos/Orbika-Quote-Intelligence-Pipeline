...
CONFIG = {'provider_id': 'impocali', 'display_name': 'Impocali', 'max_pages': 12, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': ('https://impocali.com/productos_impocali/autos/',), 'allow_category_records': True, 'extra_product_patterns': (), 'extra_category_patterns': ('/productos_impocali/autos/',), 'disallowed_url_patterns': ()}
