...
CONFIG = {'provider_id': 'pintuco', 'display_name': 'Pintuco', 'max_pages': 10, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': True, 'extra_product_patterns': ('/productos/',), 'extra_category_patterns': ('/cat_productos/automotriz',), 'disallowed_url_patterns': ()}
