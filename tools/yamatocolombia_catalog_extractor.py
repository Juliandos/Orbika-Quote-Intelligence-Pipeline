...
CONFIG = {'provider_id': 'yamatocolombia', 'display_name': 'Yamato Colombia', 'max_pages': 12, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': True, 'static_entry_urls': (), 'allow_category_records': True, 'extra_product_patterns': (), 'extra_category_patterns': (), 'disallowed_url_patterns': ()}
