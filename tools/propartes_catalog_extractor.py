...
CONFIG = {'provider_id': 'propartes', 'display_name': 'Propartes', 'max_pages': 18, 'max_products': 80, 'category_only_mode': False, 'prefer_vehicle_match': True, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': False, 'extra_product_patterns': ('/products?pageNumber=', '/filtros-de-aire/', '/filtros-automotriz'), 'extra_category_patterns': (), 'disallowed_url_patterns': ('productLowPrice=0&productHighPrice=0&sort=1&attributes=%5B%5D',)}
