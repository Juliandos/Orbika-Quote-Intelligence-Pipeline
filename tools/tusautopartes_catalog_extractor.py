...
CONFIG = {'provider_id': 'tusautopartes', 'display_name': 'Tus Autopartes', 'max_pages': 16, 'max_products': 80, 'category_only_mode': True, 'prefer_vehicle_match': False, 'collect_pdf_links': False, 'image_catalog_only': False, 'static_entry_urls': (), 'allow_category_records': True, 'extra_product_patterns': ('/products/',), 'extra_category_patterns': ('/collections/',), 'disallowed_url_patterns': ()}
