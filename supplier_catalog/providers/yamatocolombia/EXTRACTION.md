# Yamato Colombia Extraction Notes

Provider: `yamatocolombia`

Website: `https://yamatocolombia.com.co/`

Catalog root: `https://yamatocolombia.com.co/`
...
Use the brand pages and the visible product images / names. The site is not highly structured, so keep the extraction focused on visible names only.
