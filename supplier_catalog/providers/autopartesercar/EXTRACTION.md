# Autopartesercar Extraction Notes

Provider: `autopartesercar`

Website: `https://autopartesercar.com/`

Catalog root: `https://autopartesercar.com/tienda/`
...
Use the catalog filters and paginated shop pages. Product detail pages expose only brand-level information, so keep validation conservative.
