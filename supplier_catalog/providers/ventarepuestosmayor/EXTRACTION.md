# Venta Repuestos Mayor Extraction Notes

Provider: `ventarepuestosmayor`

Website: `https://ventarepuestosmayor.mybelectricosas.co/`

Catalog root: `https://ventarepuestosmayor.mybelectricosas.co/`
...
This provider points to PDF catalogs. Use it only as manual verification unless a PDF exposes reliable product text.
